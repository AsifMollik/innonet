          ...
          <div className="mt-6">
            ...
            <div className="mt-4 space-y-2">
              <div className="text-xs text-gray-600 bg-gray-50 p-3 rounded-md">
                ...
                <p><strong>Entrepreneur:</strong> karim@example.com / password123</p>
                <p><strong>Investor:</strong> rafiq@example.com / password123</p>
                <p><strong>Mentor:</strong> sarah@example.com / password123</p>
              </div>
            </div>
          </div>
        </div>
