...
const userTypeBadges: any = {
  ENTREPRENEUR: 'bg-purple-500/20 text-purple-200 border border-purple-500/30',
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div className="bg-black/90 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden border border-white/20">
                  ...
                  <div className="max-h-[calc(90vh-80px)] overflow-y-auto">
                    ...
                    {/* Send in InnoChat */}
                    <div className="p-4 border-b border-white/20">
                      <h3 className="font-semibold text-white mb-4">Send in InnoChat</h3>
                      {loadingContacts ? (
                    ...
                    {/* Share To Options */}
                    <div className="p-4">
                      <h3 className="font-semibold text-white mb-4">Share to</h3>
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        >
                          ...
                          <span className="text-sm text-purple-200">Messenger</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm text-purple-200">X</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm text-purple-200">WhatsApp</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm text-purple-200">Copy link</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm text-purple-200">Community</span>
                        </button>
                      </div>
                    </div>
                  </div>
