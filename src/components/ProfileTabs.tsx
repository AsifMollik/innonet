      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Quick Stats Card */}
            <div className="bg-white/10 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Entrepreneur Profile</h3>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {['Product Development', 'Team Leadership', 'Fundraising', 'Marketing', 'Strategy', 'AI/ML'].map((skill) => (
                  <span key={skill} className="px-3 py-1 bg-purple-500/20 text-purple-200 rounded-full text-sm font-medium border border-purple-500/30">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            {/* Current Ventures */}
            <div className="bg-white/10 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Current Ventures</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium text-white">TechBD</h4>
                    <p className="text-sm text-purple-300">Fintech Platform</p>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white">Raised $2M Series A</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white">Featured in TechCrunch</p>
