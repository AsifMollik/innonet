      ...
      case 'posts':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Posts & Updates</h2>
            {user.posts.length === 0 ? (
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span className="font-medium text-gray-900">{user.userType.replace('_', ' ')}</span>
                  </div>
                  {user.location && (
                    <div className="flex justify-between py-2 border-b border-gray-100">
          ...
          <nav className="flex space-x-8" aria-label="Tabs">
            {tabs.map((tab) => (
              <button
                ...
                } py-4 px-1 text-sm font-medium transition-colors duration-200 flex items-center gap-2`}
              >
                {tab.label}
                {tab.count !== undefined && (
                  <span className={`${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Quick Stats Card */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Entrepreneur Profile</h3>
            ...
            {/* Current Ventures */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Current Ventures</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium text-gray-900">TechBD</h4>
                    <p className="text-sm text-gray-600">Fintech Platform</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Raised $2M Series A</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Featured in TechCrunch</p>
